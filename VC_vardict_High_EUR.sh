...
-b ${bam}EUR_11_final.calmd.bam \
-F 0 -c 1 -s 2 -e 3 /mnt/lustre/groups/CBBI0818/NOELLE/SHELL/BED_CHR/CHR${CHR}.vardic.bed |${vardict}teststrandbias.R | ${vardict}var2vcf_valid.pl -N 10_GTCAATTT -E -f $AF_THR > ${out}EUR_11_highcov_final.${CHR}.vardict.vcf
